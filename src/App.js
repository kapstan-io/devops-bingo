...
const cards = [
  {
    text: "Production was on fire",
    personalities: ["The Firefighter", "The Troubleshooter", "The Hacker"],
  },
  {
    text: "Shocked by Cloud bill",
    personalities: ["The Guardian", "The Troubleshooter"],
  },
  {
    text: "Woke up at 3AM with an alert",
    personalities: ["The Troubleshooter", "The Firefighter", "The Hacker"],
  },
  {
    text: "Said “It worked on my laptop” at least once",
    personalities: ["The Hacker", "The Sprinter"],
  },
  {
    text: "Messed up manual configuration file",
    personalities: ["The Sprinter"],
  },
  {
    text: "Committed secrets or passwords to the repository",
    personalities: ["The Sprinter"],
  },
